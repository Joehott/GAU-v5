---
name: gau-65-self-generated-evals
description: Criar testes positivos e negativos derivados de critérios de aceitação. Integra a ideia 65 do GAU v5.
---

# Self-Generated Evals

## 1. Entrada e Ativação

- **Gatilho**: Criar testes positivos e negativos derivados de critérios de aceitação.
...
Consulte `.gau/docs/OPERACAO.md` para sintaxe dos comandos e `.gau/docs/CONTRATOS.md` para o contrato `generated-evals`.
...
3. **Geração do Artefato Verificável**:
   - Produza o artefato em `.gau/missions/<mission_id>/generated-evals.json`.
   - Registre: `mission`, `idea_id` (65), `status` (VERIFIED/FAILED/BLOCKED/SERIAL_LIMITED), `source`, `scope`, `evidence`, `findings`, `unknowns` e `next_actions`.
...
- Entregue o artefato `generated-evals.json`, os IDs de evidências registrados e o relatório ao coordenador.
- Condições de parada:
