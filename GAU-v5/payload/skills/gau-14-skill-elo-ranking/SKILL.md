---
name: gau-14-skill-elo-ranking
description: Comparar skills realmente usadas e colocar experimentais em observação. Integra a ideia 14 do GAU v5.
---
...
- **Gatilho**: Comparar skills realmente usadas e colocar experimentais em observação.
...
Consulte `.gau/docs/OPERACAO.md` para sintaxe dos comandos e `.gau/docs/CONTRATOS.md` para o contrato `skill-elo`.
...
3. **Geração do Artefato Verificável**:
   - Produza o artefato em `.gau/missions/<mission_id>/skill-elo.json`.
   - Registre: `mission`, `idea_id` (14), `status` (VERIFIED/FAILED/BLOCKED/SERIAL_LIMITED), `source`, `scope`, `evidence`, `findings`, `unknowns` e `next_actions`.
...
- Entregue o artefato `skill-elo.json`, os IDs de evidências registrados e o relatório ao coordenador.
- Condições de parada:
