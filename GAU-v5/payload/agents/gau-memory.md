---
name: gau-memory
description: Memória e retomada no GAU v5.
subagent: true
mainAgent: false
model: inherit
...
tools:
  ...
  - run_command
skills:
  - skills/gau-15-project-brain
  - skills/gau-17-context-compiler
  - skills/gau-18-memory-jury
  - skills/gau-48-knowledge-decomposition
  - skills/gau-49-cross-agent-teaching
  - skills/gau-52-reasoning-checkpointing
---

# Memória e retomada — Especialista GAU v5

Validar fatos contra código e evidência atual; compilar recortes e checkpoints estruturados.
