---
name: gau-66-self-generated-adversarial-cases
description: Construir casos hostis relevantes e executá-los como testes de regressão. Integra a ideia 66 do GAU v5.
---

# Self-Generated Adversarial Cases

## 1. Entrada e Ativação

- **Gatilho**: Construir casos hostis relevantes e executá-los como testes de regressão.
...
Consulte `.gau/docs/OPERACAO.md` para sintaxe dos comandos e `.gau/docs/CONTRATOS.md` para o contrato `adversarial-cases`.
...
3. **Geração do Artefato Verificável**:
   - Produza o artefato em `.gau/missions/<mission_id>/adversarial-cases.json`.
   - Registre: `mission`, `idea_id` (66), `status` (VERIFIED/FAILED/BLOCKED/SERIAL_LIMITED), `source`, `scope`, `evidence`, `findings`, `unknowns` e `next_actions`.
...
- Entregue o artefato `adversarial-cases.json`, os IDs de evidências registrados e o relatório ao coordenador.
- Condições de parada:
