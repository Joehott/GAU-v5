...
def main():
    ...
    ps1_lines = [
        ...
        'param(',
        '    [string]$Project = $PWD,',
        '    [string]$Url = "https://raw.githubusercontent.com/Joehott/GAU-v5/main/downloads/GAU-v5.zip"',
        ')',
        '',
    ...
    sh_lines = [
        ...
        'set -e',
        'PROJECT="${1:-$PWD}"',
        'URL="${GAU_URL:-https://raw.githubusercontent.com/Joehott/GAU-v5/main/downloads/GAU-v5.zip}"',
        '',
